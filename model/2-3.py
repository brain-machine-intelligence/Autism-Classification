...
h_trans_ext = tf.reshape(h_trans, (-1, mri_height, mri_width, mri_channel))
...
np.save('2C_3D_original_mri_images', np.reshape(batch_xs_orig, (-1,  mri_height, mri_width, mri_channel)))
np.save('2C_3D_translated_mri_images', tranlated_img)
