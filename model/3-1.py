...
W_conv1 = weight_variable([filter_size, filter_size, mri_channel, n_filters_1])
...
for i in range(nGlimpse):
    ...
    h_conv1 = tf.nn.relu(tf.nn.conv2d(input=h_trans_ext, filter=W_conv1, strides=[1, 2, 2, 1], padding='SAME') + b_conv1)
